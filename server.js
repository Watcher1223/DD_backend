...
server.listen(PORT, () => {
  ...
  console.log(`  NanoBanana:${process.env.NANOBANANA_API_KEY ? ' configured' : ' MOCK MODE (pollinations.ai)'}`);
  console.log(`  Lyria:     ${process.env.LYRIA_API_KEY ? 'configured' : 'MOCK MODE (preset tracks)'}`);
  console.log('');
});
